...
import { StreamedToken, Token, TokenType } from "@ast/Token"
...
import { ArgCall, Call, StringCall, TableCall } from "@ast/expressions/CallExpr"
...
import { IfStat, ElseClause } from "@ast/statements/IfStat"
import { DoStat } from "@ast/statements/DoStat"
import { WhileStat } from "@ast/statements/WhileStat"
import { NumericForStat, GenericForStat } from "@ast/statements/ForStat"
...
export function parse(input: string): Block {
	...
	function subexpr(limit: number): Expression {
		...
		else panic("curNode is undefined")
	}
